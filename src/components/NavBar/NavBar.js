    ...
    <>
      <div className="d-none d-md-flex w-100 justify-content-center ">
        <ul className="container-fluid nav nav-pills nav-fill justify-content-between p-1 bg-secondary">
          ...
          <li className="nav-item col">
            {user ? (
              <button onClick={handleLogout} className="btn btn-outline-light rounded-pill ms-2">
                <i className="bi bi-box-arrow-right me-1"></i>Cerrar session
              </button>
            ) : (
              <NavLink to="/login" className={link}><i className="bi bi-person-circle pe-1"></i>Login</NavLink>
            )}
          </li>
          ...
          <li className="nav-item col"><NavLink to="/settings" className={link}>
            <i className="bi bi-gear pe-1"></i>
            <span className="d-none d-lg-inline">Configuración</span></NavLink></li>  era antes lo que hizo Vadim*/}
      ...
      <nav className="d-md-none navbar bg-primary">
        <div className="nav-container">
          ...
          <ul className={click ? "nav-menu active bg-primary " : "nav-menu"}>
            <li className="nav-item">
              {/*en mobil si has entrado - btn - salir , sino - login */}
              ...
              {user ? (
                ...
                <NavLink exact to="/login" className="nav-links" activeClassName="active" onClick={handleClick}>
              ...
              <li className="nav-item">
                <li className="nav-item">
                  <NavLink to="/settings" className="nav-links" onClick={handleClick}>
                    <i className="bi bi-gear pe-1"></i>Configuración</NavLink>
                </li>
              </li>
            )}
            {/* <li className="nav-item">
