    ...
    <>
      <div className="d-flex justify-content-center align-items-center mx-5 my-3 bg-dark rounded rounded-5">
        ...
        <div className="d-flex flex-column position-absolute justify-content-center w-75 px-5">
          <h3 className="text-light display-5 mb-3 text-center fw-bold">
            Tu compañero indispensable
          </h3>
          <p className="lead text-light text-center fs-3">
          ...
          <button className="align-self-center btn btn-primary rounded rounded-5 px-4 py-2 fs-4">
            Ir al mapa
          </button>
        </div>
      </div>
